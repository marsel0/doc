...
Trade method — сочетание `paymentType`, банка и валюты, доступное конкретному
магазину. Коды можно получить от платформы заранее, хранить в собственном
маппинге или запрашивать через API ниже. API также возвращает названия, доступность
...
5. При ошибке `T10000`, `B10000` или `P10000` проверьте согласованные коды и
   собственный маппинг либо запросите список методов заново.
