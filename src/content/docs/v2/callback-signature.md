...
## Что нужно передать при создании PayIn-ордера или PayOut-ордера
...
`success`; новое изменение статуса PayIn-ордера или PayOut-ордера снова создаёт уведомление со значением
`in_progress`.
