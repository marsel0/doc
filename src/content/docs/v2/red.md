...
площадка вернула при создании ордера. Магазину не нужно показывать реквизиты.
...
| Ошибка | Что делать |
| --- | --- |
| Таймаут создания (`S10002`) | Найдите ордер по `externalOrderId`; не создавайте новый вслепую |
