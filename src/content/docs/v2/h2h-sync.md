...
1. Используйте согласованные `paymentType + bank`. Их можно хранить в собственном
   маппинге или [получать через API](/doc/api/shop/04-dictionaries/#получение-методов),
...
согласованный код, собственный маппинг или
...
| `B10000`, `P10000`, `T10000` | Проверьте согласованные коды и собственный маппинг либо запросите методы через API |
