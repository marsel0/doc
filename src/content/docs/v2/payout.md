...
1. Выберите согласованный метод из собственного маппинга или получите методы через
...
| `payment.bank` | нет, рекомендуется | Согласованный `bank` или код из [PayOut-методов и банков](/doc/api/payout/04-dictionaries/#get-shoptrade-methodspayout); без него платформа использует BIN карты или fallback |
...
Состав `customer.requisites` задайте в согласованном маппинге или определяйте по
...
| `B10000`, `P10000`, `P10001`, `T10000` | Проверьте согласованные коды, собственный маппинг и обязательные реквизиты; при необходимости запросите методы через API |
